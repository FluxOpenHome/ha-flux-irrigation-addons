...
- **Upcoming Service Banner** — When management schedules a service date, a green banner appears on the homeowner dashboard showing the date and any management notes; tap the banner to download a calendar event (.ics file) for your phone or computer calendar
