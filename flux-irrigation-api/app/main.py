...
Management features have been moved to the Ripple Management Server (cloud).

Author: Brandon / Ripple
"""
...
def _setup_rest_command_proxy():
    ...
    PACKAGE_CONTENT = """# Auto-generated by Ripple Irrigation Control add-on
...
async def lifespan(app: FastAPI):
    ...
    print("[MAIN] Ripple Irrigation Control starting...")
    ...
    print("[MAIN] Ripple Irrigation Control shutting down.")


# --- FastAPI App ---
app = FastAPI(
    title="Ripple Irrigation Control",
    description=(
        "Homeowner irrigation management for Ripple. "
