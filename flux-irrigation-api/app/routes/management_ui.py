...
function renderCustomerGrid(customers) {
    ...
    grid.innerHTML = customers.map(c => {
        ...
        if (issueCount > 0 && issueSummary && issueSummary.issues) {
            ...
            if (clarCount > 0) issueBadgeHtml += '<span style="display:inline-block;margin-left:4px;padding:1px 7px;border-radius:8px;font-size:11px;font-weight:700;background:#3498db22;color:#3498db;" title="' + clarCount + ' clarification">&#10068; ' + clarCount + '</span>';
        }
