...
<title>Flux Irrigation - Homeowner Dashboard</title>
...
async function loadHistory() {
    ...
    try {
        const data = await api('/history/runs?hours=24');
