...
<title>Ripple - Homeowner Dashboard</title>
...
:root {
    ...
    --color-link: #3498db;
    --color-info: #2196F3;
    --header-gradient: linear-gradient(to right, #00bad0 0%, #007e93 40%, #00697b 100%);
...
<div class="header">
    <div class="header-left">
        <img src="data:image/png;base64," alt="Ripple" class="header-logo">
        <h1>Irrigation</h1>
    </div>
...
async function cloneToDashboard() {
    var ok = await showConfirm({ title: 'Create HA Dashboard', message: 'Create (or update) a native Home Assistant dashboard called <strong>"Ripple Irrigation"</strong> from your current system configuration?', confirmText: 'Create Dashboard', confirmClass: 'btn-primary', icon: fluxIcon('gear',28) });
    if (!ok) return;
    try {
...
function renderScheduleCard(sched, durData, multData) {
    ...
    if (zone_enables.length > 0 || run_durations.length > 0) {
        ...
        // Zone mode selector ALWAYS renders in Device Controls (its original
        // home — keeps the Zone Settings rows uniform, no extra Mode column).
        // The zone's ROW (Enable/Not Used/Duration) stays in Zone Settings
        // like any other zone UNLESS it's acting as pump/master/not-used.
        var pumpMasterZones = [];  // [{mode: <entity>}] for the Device Controls dropdown
        sortedZones = sortedZones.filter(function(zn) {
            if (!zoneMap[zn].mode) return true;
            pumpMasterZones.push({ mode: zoneMap[zn].mode });
            var m = (zoneMap[zn].mode.state || '').toLowerCase();
            delete zoneMap[zn].mode;  // never render a Mode dropdown in the row
            return !/pump|master|relay|not.?used/.test(m);
        });
        // Store for Device Controls card rendering
        window._pumpMasterZones = pumpMasterZones;
...
async function loadHoMoistureDevices(showAll) {
    ...
    try {
        ...
        if (filtered && devices.length < totalCount) {
            toggleEl.innerHTML = 'Showing ' + devices.length + ' Ripple gophr device' + (devices.length !== 1 ? 's' : '') +
            ...
            toggleEl.innerHTML = 'Showing all ' + totalCount + ' devices. <a href="#" onclick="_hoMoistureShowAll=false;loadHoMoistureDevices(false);return false;">Show only Ripple devices</a>';
            toggleEl.style.display = '';
        } else {
...
<p style="margin-bottom:10px;">Your irrigation schedule is configured through your Ripple controller and managed via its ESPHome entities:</p>
...
<div style="background:var(--bg-tile);border-radius:6px;padding:8px 12px;margin:8px 0 12px 0;font-size:13px;"><span data-fi="lightbulb" data-fs="16"></span> The report is generated server-side and branded with Ripple and gophr logos. Your management company can customize the report with their own logo, company name, accent color, section visibility, and footer text.</div>
