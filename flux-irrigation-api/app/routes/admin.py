...
<div class="container">
    ...
    <div class="card" id="managementAccessCard">
        ...
        <div class="card-body">
            <p style="margin-bottom:16px; color:var(--text-secondary); font-size:14px;">
                ...
                They paste this key into their Ripple Irrigation Control add-on to connect.
            </p>
            ...
            <div id="connectionKeyDisplay" class="new-key-display" style="display:none;">
                ...
                <p class="warning">Share this key with your management company. They paste it into their Ripple Irrigation Control add-on.</p>
    ...
    <div class="card" id="appConnectionKeyCard">
        ...
        <div class="card-body">
            <p style="margin-bottom:16px; color:var(--text-secondary); font-size:14px;">
                Generate a connection key to link this irrigation system to your iPhone&rsquo;s Ripple app.
            ...
            <div id="appConnectionKeyDisplay" class="new-key-display" style="display:none;">
                ...
                <p class="warning">Open the Ripple app on your iPhone &rarr; Add Device &rarr; Link Home Assistant &rarr; paste this key.</p>
                <div style="display:flex;gap:8px;flex-wrap:wrap;">
...
<script>
    ...
    function emailConnectionKey() {
        ...
        const subject = encodeURIComponent(label + ' — Ripple Connection Key');
        const body = encodeURIComponent(
            'Hello,\\n\\n' +
            'Here is the connection key for "' + label + '":\\n\\n' +
            key + '\\n\\n' +
            'To connect:\\n' +
            '1. Open your Ripple Irrigation Control add-on\\n' +
    ...
    function emailAppConnectionKey() {
        ...
        var subject = encodeURIComponent(label + ' — Ripple iPhone App Key');
        var body = encodeURIComponent(
            'Hello,\\n\\n' +
            'Here is your iPhone app connection key for "' + label + '":\\n\\n' +
            key + '\\n\\n' +
            'To connect:\\n' +
            '1. Open the Ripple app on your iPhone\\n' +
            '2. Tap "Add Device"\\n' +
